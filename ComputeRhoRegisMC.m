function [rhoregis,conf_rhoregis] = ...
    ComputeRhoRegisMC(T,P,IpT,Ip0,Ispk,Iamb,Nspk,Namb,a,L10KS,sig_T,sig_P,sig_IpT,sig_Ip0,sig_Ispk,sig_Iamb,sig_Nspk,sig_Namb,sig_a,sig_L10KS)
...
[rhoregis] = ComputeRhoRegis(T,P,IpT,Ip0,Ispk,Iamb,Nspk,Namb,a,L10KS,sig_T,sig_P,sig_IpT,sig_Ip0,sig_Ispk,sig_Iamb,sig_Nspk,sig_Namb,sig_a,sig_L10KS);
...
for i=1:N
    ...
    elseif (Ip02-IpT2)/(Nspk2+Namb2)+(Is0-a2*IpT2)/P2 <=0
        ...
        temp=ComputeRhoRegis(T2,P2,IpT2,Ip02,Ispk2,Iamb2,Nspk2,Namb2,a2,L10KS2,sig_T,sig_P,sig_IpT,sig_Ip0,sig_Ispk,sig_Iamb,sig_Nspk,sig_Namb,sig_a,sig_L10KS);
        rho_temp(i)=temp;
    end
end
rho_temp=sort(rho_temp);
conf_rhoregis = [rho_temp(round(N*0.15865)) rho_temp(round(N*0.84135))];