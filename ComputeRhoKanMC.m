function [rhokan,sig_rhokan] = ...
    ComputeRhoKanMC(T,P,IpT,Ip0,Ispk,Iamb,Nspk,Namb,a,sig_T,sig_P,sig_IpT,sig_Ip0,sig_Ispk,sig_Iamb,sig_Nspk,sig_Namb,sig_a)
...
% al. (submitted) and uncertainty estimates (symmetric).  This code also calculates 
...
[rhokan] = ComputeRhoKanda(T,P,IpT,Ip0,Ispk,Iamb,Nspk,Namb,a,sig_T,sig_P,sig_IpT,sig_Ip0,sig_Ispk,sig_Iamb,sig_Nspk,sig_Namb,sig_a);
...
for i=1:N
    ...
    elseif Is0 <= Ip02
        ...
        temp=ComputeRhoKanda(T2,P2,IpT2,Ip02,Ispk2,Iamb2,Nspk2,Namb2,a2,sig_T,sig_P,sig_IpT,sig_Ip0,sig_Ispk,sig_Iamb,sig_Nspk,sig_Namb,sig_a);
        rho_temp(i)=temp;
    end
end
rho_temp=sort(rho_temp);
sig_rhokan = [rho_temp(round(N*0.15865)) rho_temp(round(N*0.84135))];